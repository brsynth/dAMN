...
class MetabolicModel(tf.keras.Model):
    ...
    def __init__(self, times, Transport, Stoichiometry, rxn_ids, biomass_rxn_id, 
        ...
        self.weight_decay = weight_decay # loss weight for constraints
    ...
    def call(self, C_ref_batch, training=False, verbose=False):
        ...
        for t in tf.range(T):
            ...
            loss_decay = tf.exp(-self.weight_decay * tf.cast(t, tf.float32)) 
            mse_sv +=  mse_neg_v * loss_decay
            total_loss_cnst += 0.001 * mse_sv 
            ...
            loss_decay = tf.exp(-self.weight_decay * tf.cast(t, tf.float32)) 
            total_loss_conc += mse_conc * loss_decay # * loss_weight_conc
            ...
            C_pred = C_next
                ...
                tf.print(f'Batch: {i} Time step {t} '
                         ...
                         f'Loss const: {total_loss_cnst:.3f} Loss conc: {total_loss_conc:.3f}')

        return total_loss_snst, total_loss_conc
